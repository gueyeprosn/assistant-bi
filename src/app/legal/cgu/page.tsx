export default function CguPage() {
  return (
    <>
      ...
      <p>Numéro sénégalais + PIN. Un compte = un commerce. Le PIN n’est jamais stocké en clair.</p>
      ...
      <p className="text-muted text-sm pt-6">Droit sénégalais · Dakar. Référence : docs/legal/cgu.md</p>
    </>
  );
}
